...
public class CertificateGeneratorold {
    ...
    public static X509Certificate generateRootCA(X500Name subject, long serial) throws Exception {
    ...
    public static X509Certificate generateSubCA(X500Name subject, long serial,
    ...
    public static X509Certificate generateLeafCert(X500Name subject, long serial,
                                                   X509Certificate issuerCert, PrivateKey issuerKey) throws Exception {
        KeyPair keyPair = generateKeyPair();
        X500Name issuer = new X500Name(issuerCert.getSubjectX500Principal().getName());
